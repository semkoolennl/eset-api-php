...
use Eset\Api\Resources\Payment;
use Eset\Api\Resources\PaymentCollection;
use Eset\Api\Resources\Refund;
use Eset\Api\Resources\ResourceFactory;

class PaymentEndpoint extends ResponseEndpointAbstract
{
    ...
    /**
     * Retrieves a collection of Payments from Eset.
     *
